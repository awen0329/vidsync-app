...
type Model struct {
	...
	LocalDirectoryTreeStub        func(string, string, int, bool) ([]*model.TreeEntry, error)
	localDirectoryTreeMutex       sync.RWMutex
	localDirectoryTreeArgsForCall []struct {
		arg1 string
		arg2 string
		arg3 int
		arg4 bool
	}
	localDirectoryTreeReturns struct {
		result1 []*model.TreeEntry
		result2 error
	}
	localDirectoryTreeReturnsOnCall map[int]struct {
		result1 []*model.TreeEntry
		result2 error
	}
...
func (fake *Model) LocalDirectoryTree(arg1 string, arg2 string, arg3 int, arg4 bool) ([]*model.TreeEntry, error) {
	fake.localDirectoryTreeMutex.Lock()
	ret, specificReturn := fake.localDirectoryTreeReturnsOnCall[len(fake.localDirectoryTreeArgsForCall)]
	fake.localDirectoryTreeArgsForCall = append(fake.localDirectoryTreeArgsForCall, struct {
		arg1 string
		arg2 string
		arg3 int
		arg4 bool
	}{arg1, arg2, arg3, arg4})
	stub := fake.LocalDirectoryTreeStub
	fakeReturns := fake.localDirectoryTreeReturns
	fake.recordInvocation("LocalDirectoryTree", []interface{}{arg1, arg2, arg3, arg4})
	fake.localDirectoryTreeMutex.Unlock()
	if stub != nil {
		return stub(arg1, arg2, arg3, arg4)
	}
	if specificReturn {
...
func (fake *Model) LocalDirectoryTreeCallCount() int {
	fake.localDirectoryTreeMutex.RLock()
	defer fake.localDirectoryTreeMutex.RUnlock()
	return len(fake.localDirectoryTreeArgsForCall)
}

func (fake *Model) LocalDirectoryTreeCalls(stub func(string, string, int, bool) ([]*model.TreeEntry, error)) {
	fake.localDirectoryTreeMutex.Lock()
	defer fake.localDirectoryTreeMutex.Unlock()
	fake.LocalDirectoryTreeStub = stub
}

func (fake *Model) LocalDirectoryTreeArgsForCall(i int) (string, string, int, bool) {
	fake.localDirectoryTreeMutex.RLock()
	defer fake.localDirectoryTreeMutex.RUnlock()
	argsForCall := fake.localDirectoryTreeArgsForCall[i]
	return argsForCall.arg1, argsForCall.arg2, argsForCall.arg3, argsForCall.arg4
}

func (fake *Model) LocalDirectoryTreeReturns(result1 []*model.TreeEntry, result2 error) {
	fake.localDirectoryTreeMutex.Lock()
	defer fake.localDirectoryTreeMutex.Unlock()
	fake.LocalDirectoryTreeStub = nil
	fake.localDirectoryTreeReturns = struct {
		result1 []*model.TreeEntry
		result2 error
	}{result1, result2}
}

func (fake *Model) LocalDirectoryTreeReturnsOnCall(i int, result1 []*model.TreeEntry, result2 error) {
	fake.localDirectoryTreeMutex.Lock()
	defer fake.localDirectoryTreeMutex.Unlock()
	fake.LocalDirectoryTreeStub = nil
	if fake.localDirectoryTreeReturnsOnCall == nil {
		fake.localDirectoryTreeReturnsOnCall = make(map[int]struct {
			result1 []*model.TreeEntry
			result2 error
		})
	}
	fake.localDirectoryTreeReturnsOnCall[i] = struct {
		result1 []*model.TreeEntry
		result2 error
	}{result1, result2}
}
