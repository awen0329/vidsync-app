...
export function ProjectsNav({
  ...
  // When collapsed, the navigator shrinks to a slim expand rail. The
  // review player's "files panel" layout toggle drives this too.
  collapsed?: boolean;
  ...
  if (collapsed) {
    return (
      <aside className="flex w-10 shrink-0 flex-col items-center border-r border-line bg-panel py-3">
        <button
          type="button"
        ...
        >
          <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4" aria-hidden>
            ...
            <path d="M9 4v16M13 10l2 2-2 2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
      </aside>
    );
        ...
        <div className="flex items-center gap-0.5">
          ...
          {onSetCollapsed && (
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4" aria-hidden>
                <rect x="3" y="4" width="18" height="16" rx="2" stroke="currentColor" strokeWidth="1.8" />
                <path d="M9 4v16M15 10l-2 2 2 2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
          )}
        </div>
